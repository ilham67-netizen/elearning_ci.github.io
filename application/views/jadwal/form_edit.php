          ...
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class='breadcrumb-header'>
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="<?= site_url($this->uri->segment(1) . '/') ?>">Menu Jadwal</a></li>
                      <li class="breadcrumb-item"><a href="<?= site_url($this->uri->segment(1) . '/lihat_jadwal/' . $this->uri->segment(3)) ?>">Lihat Jadwal Prodi</a></li>
  ...
  <section class="section">
      <div class="card">
          <div class="card-content">
              <div class="card-body">
                  <form class="form form-vertical" action="<?= site_url('jadwal/process/' . $this->uri->segment(4)) ?>" method="POST">
                      <div class="form-body">
                          <div class="row">
                              <div class="col-12">
  ...
  <script type="text/javascript">
      ...
      var foto_upload = new Dropzone(".dropzone", {
          url: "<?= site_url('jadwal/file_upload/' . $this->uri->segment(3)) ?>",
          maxFilesize: 7,
          method: "post",
      ...
      foto_upload.on("removedfile", function(a) {
          ...
          $.ajax({
              ...
              url: "<?= site_url('jadwal/hapus_file') ?>",
              cache: false,
              dataType: 'json',
              success: function() {
      ...
      $(".tombol-hapus").on('click', function(e) {
          ...
          Swal.fire({
              ...
              if (result.isConfirmed) {
                  $.ajax({
                      url: "<?= site_url('jadwal/hapus_file2') ?>",
                      method: "POST",
                      data: {
                          token: token,
  ...
  <script>
      $(document).ready(function() {
          $("#flexSwitchCheckDefault").on('click', function() {
              var kd_jadwal = '<?= $this->uri->segment(3); ?>';
              if (this.checked) {
                  var status = "1";
                  $.ajax({
                      type: "POST",
                      ...
                      url: "<?= site_url('jadwal/check_absen') ?>",
                      cache: false,
                      dataType: 'json',
                      success: function(data) {
          ...
          $("#flexSwitchCheckDefault2").on('click', function() {
              ...
              if (this.checked) {
                  ...
                  $.ajax({
                      ...
                      url: "<?= site_url('jadwal/aktifkan_kuliah') ?>",
                      cache: false,
                      dataType: 'json',
                      success: function(data) {
