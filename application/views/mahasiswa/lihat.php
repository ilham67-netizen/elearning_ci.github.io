...
<section class="section">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="modal fade" id="modal_prodi" tabindex="-1" role="dialog"
      ...
      $.ajax({
        ...
        success : function(data){
         ...
         for(i=0; i<data.length; i++){
          ...
          html += '<td> <a class="badge bg-primary" href="<?= site_url('master_data/mahasiswa/lihat_mhs/')?>'+data[i].kd_prodi+'">Lihat Mahasiswa</a></td>';
          html += '</tr>';
        }
