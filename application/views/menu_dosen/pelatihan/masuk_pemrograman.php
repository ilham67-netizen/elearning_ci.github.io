...
<body>
    <div class="panel-primary header">
        <div class="panel-heading">
            ...
            <center><a style=" float: left; margin-right: 10px; margin-left: 500px;" href="<?= site_url("menu_dosen/pelatihan/download_pelatihan/" . $this->uri->segment(4)) ?>" class="btn btn-danger center-block" style=" float: left; margin-right: 10px; ">SOAL</a></center>
            <form class="form">
