         ...
         <div class="col-12 col-md-6 order-md-2 order-first">
             <nav aria-label="breadcrumb" class='breadcrumb-header'>
                 <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active">Menu Pengaturan Ujian</li>
                 </ol>
             </nav>
         </div>
     </div>
         ...
         <div class="card-body">
             ...
             <div class="table-responsive">
                 <table class='table table-striped' id="dataTable">
                     ...
                     <tbody>
                         <?php foreach ($pengaturan as $data) : ?>
                             <tr>
                                 ...
                                 <td><a class="badge bg-success" href="<?= site_url('menu_dosen/pengaturan_ujian/edit_hal/' . $data->kd_pengawas) ?>"><i data-feather="edit" width="20"></i>Edit</a>
                                     <a href="<?= site_url('menu_dosen/pengaturan_ujian/del/' . $data->kd_pengawas) ?>" class="badge bg-danger tombol-delete"> <i data-feather="trash" width="20"></i> Delete</a>
                                     <?php if ($data->status > 0) {
                                            echo '<a href="' . site_url('menu_dosen/pengaturan_ujian/hal_detail/' . $data->kd_pengawas) . '" class="badge bg-success"> <i data-feather="eye" width="20"></i> Lihat Detail</a>';
                                        } ?>
                                 </td>
                             </tr>
                         <?php endforeach; ?>
         ...
         <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     <form action="<?= site_url('menu_dosen/pengaturan_ujian/process'); ?>" method="POST">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" class="form-control" name="nama_pengawas" placeholder="Masukkan Nama Pengawas" required>
                         </div>
                         <div class="form-group">
                             <label for="">Nama Ujian</label>
                             <input type="text" class="form-control" name="nama_ujian" placeholder="Masukkan Nama Ujian" required>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             ...
                             <input type="hidden" class="form-control" name="nip_dosen" value="<?= $this->session->userdata('userid') ?>">
                         </div>
