         ...
         <div class="col-12 col-md-6 order-md-2 order-first">
             <nav aria-label="breadcrumb" class='breadcrumb-header'>
                 <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item"><a href="<?= site_url("menu_dosen/pengaturan_ujian/") ?>">Menu Pengaturan Ujian</a></li>
 ...
 <script>
     $(document).ready(function() {
         ...
         function tampil_ujian() {
             $.ajax({
                 type: 'GET',
                 url: '<?= site_url('menu_dosen/pengaturan_ujian/jajal/' . $this->uri->segment(4)); ?>',
                 async: true,
                 dataType: 'json',
                     ...
                     for (i = 0; i < data.length; i++) {
                         if (data[i].penilaian.length > 0) {
                             ...
                             for (i2 = 0; i2 < data[i].penilaian.length; i2++) {
                                 if (data[i].jenis == 3) {
                                     html += '<td>' +
                                         '<a href="<?= site_url('menu_dosen/pengaturan_ujian/lihat_koding/') ?>' + data[i].nim + '/' + data[i].penilaian[i2].kd_pengawas + '/' + data[i].penilaian[i2].id_nilai + '" class="badge bg-success"><span data-feather="eye"></span> Lihat Jawaban</a>'
                                 } else {
                                     html += '<td>' +
                                         '<a href="<?= site_url('menu_dosen/pengaturan_ujian/lihat_jawaban/') ?>' + data[i].nim + '/' + data[i].penilaian[i2].kd_pengawas + '" class="badge bg-success"><span data-feather="eye"></span> Lihat Jawaban</a>'
                                 }
