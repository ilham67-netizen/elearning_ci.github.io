                         ...
                         <?php
                            ...
                            ?>
                             <tr>
                                 ...
                                 <td><a class="badge bg-success" href="<?= site_url('menu_dosen/paket_soal/edit_paket/' . $d->kd_paket) ?>"><i data-feather="edit" width="20"></i>Edit</a>
                                     <a href="<?= site_url('menu_dosen/paket_soal/del/' . $d->kd_paket) ?>" class="badge bg-danger tombol-delete"> <i data-feather="trash" width="20"></i> Delete</a>
                                     <?php if ($d->jenis_soal != 3) { ?>
                                         <a class="badge bg-primary" href="<?= site_url('menu_dosen/paket_soal/lihat_soal/' . $d->kd_paket) ?>"><i data-feather="eye" width="20"></i>Lihat Soal</a>
                                     <?php } else {
                                            echo '<a class="badge bg-primary" href="' . site_url("menu_dosen/paket_soal/download_soal/" . $d->kd_paket) . '"><i data-feather="download" width="20"></i>Unduh Soal</a>';
                                        } ?>
                             </tr>
                         <?php } ?>
                     </tbody>
         ...
         <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     <form class="form form-vertical" action="<?= site_url('menu_dosen/paket_soal/process') ?>" method="POST" enctype="multipart/form-data">
                         <div class="form-body">
                             <div class="row">
                                 <div class="col-12">
