 ...
 <section class="section" style="margin-bottom: 0;">
                             ...
                             <h5><?php if ($row->status == 0) {
                                        ...
                                        if ($jam <= 0 || $menit <= 0) {
                                            if ($row->waktu_akhir != '' || $row->waktu_akhir != NULL) {
                                                ...
                                                echo '<a href="' . site_url('menu_mhs/kuliah/kuliah_daring/' . $row->kd_jadwal) . '" class="btn btn-outline-primary"><span data-feather="log-in"></span>Masuk Kuliah</a></h5>';
                                            }
                                        }
                                    } ?>
                         </div>
     ...
     <div class="card">
         <div class="card-body">
             <h2>Kuliah Online Hari Yang Akan Datang</h2><br>
             <div class="row">
                         ...
                         <?php
                            ...
                            ?>
                             <tr>
                                 ...
                                 <td>
                                     <a class="badge bg-primary" href="<?= site_url('menu_mhs/kuliah/lihat_absen/' . $this->uri->segment(3) . '/' . $d->kd_jadwal) ?>"><i data-feather="eye" width="20"></i>Lihat Absen</a>
                             </tr>
                         <?php } ?>
                     </tbody>
