         ...
         <div class="col-12 col-md-6 order-md-2 order-first">
             <nav aria-label="breadcrumb" class='breadcrumb-header'>
                 <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item"><a href="<?= site_url("menu_mhs/kuliah/" . $this->uri->segment(2)) ?>">Menu Kuliah Online</a></li>
                     ...
                     <?php
                        ...
                        ?>
                         <tr>
                             ...
                             <td><?= $d->nim ?></td>
                             <td><?= $d->nama_mhs ?></td>
                             <td><?= indo_date(date('Y-m-d', strtotime($d->waktu_absen))) . ' || ' . date('H:i', strtotime($d->waktu_absen)) ?></td>
                         </tr>
                     <?php } ?>
                 </tbody>
             </table>
