          ...
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class='breadcrumb-header'>
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="<?= site_url('paket_soal/lihat_soal/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>">Lihat Soal</a></li>
  ...
  <section class="section">
      <div class="card">
          ...
          <div class="card-content">
              <div class="card-body">
                  <form class="form form-vertical" action="<?= site_url('paket_soal/proses_soal/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>" method="POST" enctype="multipart/form-data">
                      <div class="form-body">
                          <div class="row">
                              <div id="clone">
                                  <h2>Soal Nomor 1</h2>
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <div class="row">
                                              <div class="col" style="font-size: large; font-weight: bold; ">A. </div>
                                              <div class="col-11"><input type="hidden" name="nama_opsi[]" value="A"><input type="text" class="form-control" name="jawaban_a[]" required placeholder="Masukkan Jawaban A"></div>
                                              <div class="col-1 mt-2" style="font-size: large; font-weight: bold; ">B. </div>
                                              <div class="col-11 mt-2"><input type="hidden" name="nama_opsi[]" value="B"><input type="text" class="form-control" name="jawaban_b[]" required placeholder="Masukkan Jawaban B"></div>
                                              <div class="col-1 mt-2" style="font-size: large; font-weight: bold; ">C. </div>
                                              <div class="col-11 mt-2"><input type="hidden" name="nama_opsi[]" value="C"><input type="text" class="form-control" name="jawaban_c[]" required placeholder="Masukkan Jawaban C"></div>
                                              <div class="col-1 mt-2" style="font-size: large; font-weight: bold; ">D. </div>
                                              <div class="col-11 mt-2"><input type="hidden" name="nama_opsi[]" value="D"><input type="text" class="form-control" name="jawaban_d[]" required placeholder="Masukkan Jawaban D"></div>
                                              <div class="col-1 mt-2" style="font-size: large; font-weight: bold; ">E. </div>
                                              <div class="col-11 mt-2"><input type="hidden" name="nama_opsi[]" value="E"><input type="text" class="form-control" name="jawaban_e[]" placeholder="Masukkan Jawaban E" required></div>
                                          </div>
                                  ...
                                  <div class="col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" required="" name="kunci_jawaban[]" value="" placeholder="Masukkan Kunci Jawaban" autocomplete="off">
                                      </div>
                                  </div>
                                  <div id="lanjut"></div>
