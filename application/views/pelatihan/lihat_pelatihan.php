                     ...
                     <?php
                        ...
                        ?>
                         <tr>
                             ...
                             <td><a class="badge bg-success" href="<?= site_url('pelatihan/edit/' . $this->uri->segment(3) . '/' . $d->kd_pelatihan) ?>"><i data-feather="edit" width="20"></i>Edit</a>
                                 <a href="<?= site_url('pelatihan/del/' . $this->uri->segment(3) . '/' . $d->kd_pelatihan) ?>" class="badge bg-danger tombol-delete"> <i data-feather="trash" width="20"></i> Delete</a>
                                 <?php if ($d->status == 1) { ?>
                                     <a class="badge bg-success" href="<?= site_url('pelatihan/masuk_pelatihan/' . $this->uri->segment(3) . '/' . $d->kd_pelatihan) ?>"><i data-feather="log-in" width="20"></i>Masuk Pelatihan</a>
                                 <?php } ?>
                         </tr>
                     <?php } ?>
                 </tbody>
