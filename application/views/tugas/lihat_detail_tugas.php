         ...
         <div class="col-12 col-md-6 order-md-2 order-first">
             <nav aria-label="breadcrumb" class='breadcrumb-header'>
                 <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item"><a href="<?= site_url('tugas') ?>">Pilih Fakultas</a></li>
                     <li class="breadcrumb-item"><a href="<?= site_url("tugas/" . $this->uri->segment(2) . "/" . $this->uri->segment(3)) ?>">Menu Tugas</a></li>
 ...
 <script>
     $(document).ready(function() {
         ...
         function tampil_tugas() {
             $.ajax({
                 type: 'GET',
                 url: '<?= base_url() ?>tugas/get_tugas/<?= $this->uri->segment(4); ?>',
                 async: true,
                 dataType: 'json',
                 success: function(data) {
                     ...
                     for (i = 0; i < data.length; i++) {
                         if (data[i].nilai.length > 0) {
                             ...
                             html += '<td>' +
                                 '<a class="badge bg-success" href="<?= site_url('tugas/download_mhs/') ?>' + data[i].nim + '/' + data[i].kd_tugas + '"><i data-feather="download" width="20"></i>Download</a>'
                             if (data[i].nilai !== null) {
         ...
         $('#show_data').on('click', '.item_edit', function() {
             ...
             $.ajax({
                 type: "GET",
                 url: "<?= base_url('tugas/get_tugas_byid') ?>",
                 dataType: "JSON",
                 data: {
                     id: id
                 },
