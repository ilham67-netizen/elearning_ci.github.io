...
<body>
    <div class="card">
        <div class="card-header" style="background-color:blue;">
            <center><a class="btn btn-success btn-lg" data-toggle="modal" id="show_data" style=" float: left; margin-right: 10px; margin-left: 500px;" data-id="<?= $this->uri->segment(7); ?>" data-jenis="<?= $row->jenis_soal; ?>">UBAH NILAI</a>
                <a href="<?= site_url("ujian/download_soal/" . $row->kd_paket) ?>" class="btn btn-danger btn-lg center-block" style=" float: left; margin-right: 10px; ">SOAL</a>
            </center>
            <form class="form">
